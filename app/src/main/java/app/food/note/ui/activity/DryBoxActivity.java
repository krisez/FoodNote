...
public class DryBoxActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        topBar.setTitle(R.string.dry_box);
    ...
    private void refreshData() {
        Disposable d = RxDbManager.getInstance().query(getString(R.string.dry_box))
                .subscribe(foodBeans -> {
                    mFoodBeanList.clear();
                    mFoodBeanList.addAll(foodBeans);
                    mAdapter.notifyDataSetChanged();
                    Log.d("DryBoxActivity", "refreshData: " + foodBeans.toString());
