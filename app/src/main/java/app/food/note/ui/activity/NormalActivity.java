...
public class NormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        topBar.setTitle(R.string.normal_zone);
        ...
        refreshData();
        findViewById(R.id.other_ll).setBackgroundResource(R.mipmap.bg_normal);
    }

    private void refreshData() {
        Disposable d = RxDbManager.getInstance().query(getString(R.string.normal_zone))
                .subscribe(foodBeans -> {
                    mFoodBeanList.clear();
                    mFoodBeanList.addAll(foodBeans);
                    mAdapter.notifyDataSetChanged();
                    Log.d("NormalActivity", "refreshData: " + foodBeans.toString());
